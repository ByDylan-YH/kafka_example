...
//        props.put("schema.registry.url", "by201:8081");
    ...
    @Override
    public void run() {
        WriteMySQLUtil writeMySQLUtil = new WriteMySQLUtil();
        ...
        while (file.length() / 1024 < 3) {
            ...
            for (ConsumerRecord<String, String> record : records) {
                System.out.println(Thread.currentThread().getName() + " 分区: "
                ...
                try {
                    ...
                    sb.append(record.partition()).append("|").append(record.offset()).append("|").append(record.key()).append("|").append(record.value() + "\n");
...
//                System.out.println();
        ...
        writeMySQLUtil.WriteMySQL(file);
    }
}
